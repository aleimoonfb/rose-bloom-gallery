...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`mailto:sales1@emfacc.com,sales2@emfacc.com?subject=Consulta desde Web&body=${body}`);
  };
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:sales1@emfacc.com,sales2@emfacc.com" className="font-sans text-sm text-muted-foreground hover:text-primary">
                    sales1@emfacc.com
                  </a>
                  <a href="mailto:sales1@emfacc.com,sales2@emfacc.com" className="font-sans text-sm text-muted-foreground hover:text-primary">
                    sales2@emfacc.com
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="https://www.instagram.com/magic_roses_ec/#" target="_blank" rel="noopener noreferrer" className="font-sans text-sm text-muted-foreground hover:text-primary">
                    @magic_roses_ec
                  </a>
                </div>
              </div>
